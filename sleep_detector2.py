...
#TOTAL = 0
def get_test_cases():
	test_files = glob.glob('./tests/*.mp4')
	threshold_variations = [0.1, 0.3, 0.4, 0.5, 0.6]
	test_cases = []
	for f in test_files:
...
for file, threshold in get_test_cases():
	print(f"file: {file}\nthreshold: {threshold}")
